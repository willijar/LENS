...
(defpackage :lens
  ...
  (:export
   ...
   #:name #:full-name #:full-path #:info #:detailed-info #:dup
   #:take #:drop #:serialise #:deserialise
   #:do-insert #:for-each-child #:find-object
   #:parameter-source #:read-parameter #:paramater-class #:paramater-object
   #:component))
